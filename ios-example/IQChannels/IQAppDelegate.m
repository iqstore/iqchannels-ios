//
//  Created by Ivan Korobkov on 09/06/2016.
//
...
- (void)switchToLogin {
    self.window.rootViewController = [IQLoginController controllerWithAppDelegate:self];
}

- (void)switchToTabbar {
    self.window.rootViewController = [IQTabbarController controllerWithAppDelegate:self];
}
